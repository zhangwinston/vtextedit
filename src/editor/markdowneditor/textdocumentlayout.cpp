...
const int TextDocumentLayout::c_markerThickness = 0;  //zhangyw modify from 2 to 1
...
//    qWarning()<<"block.position() + off"<<block.position() + off;
...
int TextDocumentLayout::cursorBlockNumber()const
{
    return    m_cursorBlockNumber;
}
